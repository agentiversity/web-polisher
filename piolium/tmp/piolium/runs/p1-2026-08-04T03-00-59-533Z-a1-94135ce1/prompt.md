# Run p1-2026-08-04T03-00-59-533Z-a1-94135ce1
Agent: advisory-hunter
Source: C:\Users\mpeak\.pi\agent\npm\node_modules\@vigolium\piolium\agents\advisory-hunter.md

## Task

You are running Stage 01 (Intelligence & Dependency Risk) of /piolium-deep.

Build `piolium/attack-surface/advisory-summary.md` covering CVE/GHSA/OSV advisories, dependency intel, and architecture hints. Use the bash + WebFetch tools (run `curl` against advisory APIs if needed; WebSearch will return a fallback message — use bash+curl instead).

Target repository: C:\Users\mpeak\dev\my-polisher-extension.
